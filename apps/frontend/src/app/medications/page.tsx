  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-4 mb-4">
        <Link href="/" className="px-4 py-2 bg-gray-800 rounded-lg font-bold focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none">Geri</Link>
      ...
      <form onSubmit={handleAdd} className="flex flex-col gap-3 bg-gray-900 p-4 rounded-xl border-2 border-gray-700">
        ...
        <input
          ...
          aria-label="İlaç adı"
          className="p-3 rounded-lg bg-gray-800 border-2 border-gray-600 focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none"
        />
        <input
          value={dosage}
        ...
        <button
          type="submit"
          disabled={isAdding}
          className="bg-green-600 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed text-white p-3 rounded-lg font-bold transition-colors focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none"
        >
        ...
        {meds.map((med) => (
          ...
          >
            <button
              ...
              className="flex items-center gap-4 text-left flex-1 focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none rounded-lg"
            ...
            <button
              ...
              className="p-2 text-red-400 hover:text-red-300 focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none rounded-lg"
            >
              <Trash2 size={24} />
            </button>
          </div>
