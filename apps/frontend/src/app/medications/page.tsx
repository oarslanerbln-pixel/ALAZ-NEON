    ...
    <div className="flex flex-col gap-6">
      ...
      <form onSubmit={handleAdd} className="flex flex-col gap-3 bg-gray-900 p-4 rounded-xl border-2 border-gray-700">
        ...
        <button
          type="submit"
          disabled={isAdding}
          className="bg-green-600 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed text-white p-3 rounded-lg font-bold focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none transition-colors"
        >
