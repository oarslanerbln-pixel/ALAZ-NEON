        ...
        {meds.map(med => (
          ...
          >
            ...
            <div className="flex flex-col items-center">
              {med.taken ? <CheckCircle2 size={40} className="text-green-400 mb-1" /> : <Circle size={40} className="text-gray-400 mb-1" />}
              {med.taken && <span className="text-sm font-bold text-green-400">Alındı</span>}
            </div>
          </button>
        ))}
      </div>
