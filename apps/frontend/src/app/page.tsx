  ...
  return (
    <div className="flex flex-col gap-6 items-center justify-center min-h-[70vh]">
      ...
      {!isLoading && user && (
        <button
          onClick={signOut}
          className="w-full flex items-center justify-center gap-3 bg-gray-800 hover:bg-gray-700 text-white p-4 rounded-xl text-lg font-bold transition-colors mt-2 focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none"
        >
          <LogOut size={24} />
          Çıkış Yap
        </button>
