...
export default function RootLayout({
  ...
  return (
    <html lang="tr">
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased bg-black text-white text-lg *:focus-visible:ring-4 *:focus-visible:ring-yellow-400 *:focus-visible:outline-none`}
      >
