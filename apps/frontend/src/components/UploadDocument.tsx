    ...
    <div className="flex flex-col gap-6 items-center w-full">
      <div className="flex w-full gap-2 mb-2">
        <button
          ...
          className={`flex-1 p-3 rounded-lg font-bold text-center border-2 focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none transition-colors ${language === 'tr' ? 'bg-blue-600 border-blue-600 text-white' : 'bg-gray-800 border-gray-600 text-gray-300'}`}
        >
          TR
        </button>
        <button
          onClick={() => setLanguage('en')}
          className={`flex-1 p-3 rounded-lg font-bold text-center border-2 focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none transition-colors ${language === 'en' ? 'bg-blue-600 border-blue-600 text-white' : 'bg-gray-800 border-gray-600 text-gray-300'}`}
        >
          EN
        </button>
        <button
          onClick={() => setLanguage('ar')}
          className={`flex-1 p-3 rounded-lg font-bold text-center border-2 focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none transition-colors ${language === 'ar' ? 'bg-blue-600 border-blue-600 text-white' : 'bg-gray-800 border-gray-600 text-gray-300'}`}
        >
          AR
        </button>
      </div>
      ...
      {result && (
        <div className="w-full bg-gray-800 p-6 rounded-xl mt-4" role="status" aria-live="polite">
          ...
          <p className="text-base text-yellow-400 font-bold mt-4 pt-4 border-t border-gray-700">
