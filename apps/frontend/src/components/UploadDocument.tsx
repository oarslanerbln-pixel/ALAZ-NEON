  ...
  return (
    <div className="flex flex-col gap-6 items-center w-full">
      <div className="flex flex-col gap-2 w-full mb-4">
        <span className="text-lg font-bold">Dil Seçimi:</span>
        <div className="flex gap-2">
          <button onClick={() => setLanguage('tr')} className={`flex-1 p-3 rounded-lg font-bold border-2 focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none ${language === 'tr' ? 'bg-blue-600 border-blue-400' : 'bg-gray-800 border-gray-600'}`}>Türkçe</button>
          <button onClick={() => setLanguage('en')} className={`flex-1 p-3 rounded-lg font-bold border-2 focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none ${language === 'en' ? 'bg-blue-600 border-blue-400' : 'bg-gray-800 border-gray-600'}`}>English</button>
          <button onClick={() => setLanguage('ar')} className={`flex-1 p-3 rounded-lg font-bold border-2 focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none ${language === 'ar' ? 'bg-blue-600 border-blue-400' : 'bg-gray-800 border-gray-600'}`}>العربية</button>
        </div>
      </div>
