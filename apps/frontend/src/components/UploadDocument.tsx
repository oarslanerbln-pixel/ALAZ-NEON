    ...
    <div className="flex flex-col gap-6 items-center w-full">
      <div className="flex gap-2 w-full mb-4">
        <button
          ...
          className={`flex-1 py-3 px-2 font-bold rounded-xl border-2 transition-colors focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none ${language === 'tr' ? 'bg-blue-600 border-blue-400' : 'bg-gray-800 border-gray-600 hover:bg-gray-700'}`}
        >
          Türkçe
        </button>
        <button
          onClick={() => setLanguage('en')}
          className={`flex-1 py-3 px-2 font-bold rounded-xl border-2 transition-colors focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none ${language === 'en' ? 'bg-blue-600 border-blue-400' : 'bg-gray-800 border-gray-600 hover:bg-gray-700'}`}
        >
          English
        </button>
        <button
          onClick={() => setLanguage('ar')}
          className={`flex-1 py-3 px-2 font-bold rounded-xl border-2 transition-colors focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none ${language === 'ar' ? 'bg-blue-600 border-blue-400' : 'bg-gray-800 border-gray-600 hover:bg-gray-700'}`}
        >
          العربية
        </button>
      </div>
