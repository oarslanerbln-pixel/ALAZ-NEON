  ...
  return (
    <div className="flex flex-col gap-6 items-center w-full">
      ...
      <div className="flex gap-4 w-full justify-center">
        <button onClick={() => setLanguage('tr')} className={`px-4 py-2 rounded-lg font-bold focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none ${language === 'tr' ? 'bg-blue-600 text-white' : 'bg-gray-800 hover:bg-gray-700'}`}>Türkçe</button>
        <button onClick={() => setLanguage('en')} className={`px-4 py-2 rounded-lg font-bold focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none ${language === 'en' ? 'bg-blue-600 text-white' : 'bg-gray-800 hover:bg-gray-700'}`}>English</button>
        <button onClick={() => setLanguage('ar')} className={`px-4 py-2 rounded-lg font-bold focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none ${language === 'ar' ? 'bg-blue-600 text-white' : 'bg-gray-800 hover:bg-gray-700'}`}>العربية</button>
      </div>
