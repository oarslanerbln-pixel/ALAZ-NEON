      ...
      {result && (
        <div className="w-full bg-gray-800 p-6 rounded-xl mt-4" role="status" aria-live="polite">
          ...
          <div className="flex gap-2 mb-4">
            <button className="px-4 py-2 bg-blue-600 rounded-lg font-bold focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none">TR</button>
            <button className="px-4 py-2 bg-gray-700 rounded-lg font-bold focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none">EN</button>
            <button className="px-4 py-2 bg-gray-700 rounded-lg font-bold focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none">AR</button>
          </div>

          <p className="whitespace-pre-line text-xl">{result}</p>
          <p className="mt-6 p-4 bg-gray-900 border border-gray-700 rounded text-yellow-400 text-sm font-bold">
