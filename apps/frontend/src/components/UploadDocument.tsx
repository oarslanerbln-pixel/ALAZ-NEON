  ...
  return (
    <div className="flex flex-col gap-6 items-center w-full">
      ...
      <div className="flex justify-center gap-4 w-full">
        <button className="px-6 py-3 bg-gray-800 rounded-xl border-2 border-gray-600 font-bold focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none">TR</button>
        <button className="px-6 py-3 bg-gray-800 rounded-xl border-2 border-gray-600 font-bold focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none">EN</button>
        <button className="px-6 py-3 bg-gray-800 rounded-xl border-2 border-gray-600 font-bold focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none">AR</button>
      </div>
      ...
      <div role="status" aria-live="polite" className="w-full">
        ...
        {result && (
          <div className="w-full bg-gray-800 p-6 rounded-xl mt-4">
            ...
            <div className="p-4 bg-gray-900 border-l-4 border-yellow-400 text-sm font-bold text-yellow-400">
