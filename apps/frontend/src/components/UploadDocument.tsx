    ...
    <div className="flex flex-col gap-6 items-center w-full">
      <div className="flex justify-center gap-4 w-full">
        <button
          ...
          className={`flex-1 p-4 rounded-xl border-2 font-bold focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-yellow-400 ${language === 'TR' ? 'bg-blue-600 border-blue-400' : 'bg-gray-800 border-gray-600'}`}
        >
          Türkçe
        </button>
        <button
          onClick={() => setLanguage('EN')}
          className={`flex-1 p-4 rounded-xl border-2 font-bold focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-yellow-400 ${language === 'EN' ? 'bg-blue-600 border-blue-400' : 'bg-gray-800 border-gray-600'}`}
        >
          English
        </button>
        <button
          onClick={() => setLanguage('AR')}
          className={`flex-1 p-4 rounded-xl border-2 font-bold focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-yellow-400 ${language === 'AR' ? 'bg-blue-600 border-blue-400' : 'bg-gray-800 border-gray-600'}`}
        >
          العربية
        </button>
      </div>
