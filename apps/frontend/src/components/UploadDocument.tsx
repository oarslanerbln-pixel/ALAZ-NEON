    ...
    <div className="flex flex-col gap-6 items-center w-full">
      <div className="flex gap-2 w-full justify-center mb-2">
        <button
          ...
          className={`px-4 py-2 rounded-lg font-bold border-2 focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none ${language === 'tr' ? 'bg-yellow-400 text-black border-yellow-400' : 'bg-gray-800 text-white border-gray-600 hover:bg-gray-700'}`}
        >
          TR
        </button>
        <button
          onClick={() => setLanguage('en')}
          className={`px-4 py-2 rounded-lg font-bold border-2 focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none ${language === 'en' ? 'bg-yellow-400 text-black border-yellow-400' : 'bg-gray-800 text-white border-gray-600 hover:bg-gray-700'}`}
        >
          EN
        </button>
        <button
          onClick={() => setLanguage('ar')}
          className={`px-4 py-2 rounded-lg font-bold border-2 focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none ${language === 'ar' ? 'bg-yellow-400 text-black border-yellow-400' : 'bg-gray-800 text-white border-gray-600 hover:bg-gray-700'}`}
        >
          AR
        </button>
      </div>
