      ...
      {result && (
        <div className="w-full bg-gray-800 p-6 rounded-xl mt-4" role="status" aria-live="polite">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            <button className="px-4 py-2 bg-blue-900 text-white rounded-lg font-bold focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none" aria-label="Türkçe dilini seç">Türkçe</button>
            <button className="px-4 py-2 bg-gray-700 text-white rounded-lg font-bold focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none" aria-label="İngilizce dilini seç">English</button>
            <button className="px-4 py-2 bg-gray-700 text-white rounded-lg font-bold focus-visible:ring-4 focus-visible:ring-yellow-400 focus-visible:outline-none" aria-label="Arapça dilini seç">العربية</button>
          </div>

          <p className="whitespace-pre-line text-lg">{result}</p>

          <div className="mt-6 p-4 border border-yellow-600 bg-yellow-900 bg-opacity-20 rounded-lg">
