            ...
            <AnimatePresence mode="wait">
                ...
                <form onSubmit={handleJoin} className="glass-panel-alaz p-8 md:p-10 space-y-8 relative overflow-hidden group">
                    ...
                    <div className="space-y-3 text-left">
                        <label htmlFor="roomCodeInput" className="text-[10px] text-gray-500 font-black uppercase tracking-widest ml-1">Oda Kodu</label>
                    ...
                    <div className="space-y-3 text-left">
                        <label htmlFor="nicknameInput" className="text-[10px] text-gray-500 font-black uppercase tracking-widest ml-1">Nickname / Team Name</label>
                        <input
                            id="nicknameInput"
                            type="text"
                            required
